...
namespace EasyPagination.Core.Tests
{
    public abstract class BaseExtensionsTests
    {
        ...
        public void No_data_when_non_positive_page_is_requested()
        {
            ...
            firstPage.Items.Count.ShouldBe(0);
            firstPage.Settings.CurrentPage.ShouldBeNull();
        }
        ...
        public void Provides_first_page_data_when_default_page_options_is_used()
        {
            ...
            firstPage.Items.Count.ShouldBe(1000);
            firstPage.Items.ShouldAllBe(i => 1 <= i.Id && i.Id <= 1000);
            firstPage.Settings.CurrentPage.ShouldBe(1);
            firstPage.Settings.ItemsCount.ShouldBe(2500);
            firstPage.Settings.PageCount.ShouldBe(3);
        }
        ...
        public void Provides_last_page_data_when_it_is_smaller_than_page_size()
        {
            ...
            firstPage.Items.Count.ShouldBe(500);
            firstPage.Items.ShouldAllBe(i => 2000 <= i.Id && i.Id <= 2500);
            firstPage.Settings.CurrentPage.ShouldBe(3);
        }
        ...
        public void Provides_page_data_when_page_size_is_overriden()
        {
            ...
            firstPage.Items.ShouldAllBe(i => 1 <= i.Id && i.Id <= 2);
        }
        ...
        public void Provides_particular_page_data_when_it_is_passed_into_page_options()
        {
            ...
            firstPage.Items.Count.ShouldBe(1000);
            firstPage.Items.ShouldAllBe(i => 1001 <= i.Id && i.Id <= 2000);
            firstPage.Settings.CurrentPage.ShouldBe(2);
        }
